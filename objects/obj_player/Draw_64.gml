...
switch(state)
{
	...
	case _state.sleep:
		...
		if sleepTimer > 120
		{
			draw_text_scribble(windowWidth/2,30,"[fa_center][#306230][scale,0.5]" + sleepText)
		}
		if sleepTimer > 180
		{
			draw_text_scribble(windowWidth/2,45,"[fa_center][#306230][scale,0.25]Hit your action key to continue")
